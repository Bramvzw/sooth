...
| **v0.2** | **Flaky detection** — fixed run order, N repeats, failure-rate ranking. The core value. |
...
| **v1.0** | Polish + distribution + launch — on the core, not gated on network egress. |
